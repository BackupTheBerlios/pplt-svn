...
class PrimitiveCanvas(wx.ScrolledWindow):
    ...
    def __init__(self, parent, ID=-1, virtSize=(200,200)):
        """ Constuctor. This method takes the parent window C{wx.Window} and 
            ...
            raster. By default it is 200x200. 
            
            @bug: The size of the canvas is currently fixed to 200x200!
    ...
    def beginDrawing(self):
        """ This method will create an empty drawingcontext to be used to
            ...
            @return: Returns the drawing context of the canvas. You need to
                finalize the drawing by calling C{self.endDrawing(dc)} with
                this DC as argument. """
