...
class SequenceReflectionModule(CModule, ISequenceModule):
    _d_timeout  = None;
    _d_logger   = None;
    ...
    def __init__(self, parameters = None):
        ...
        self._d_logger.debug("Setup SequenceReflectionModule with timeout %s"%self._d_timeout);
    ...
    def connect(self, addr, child=None):
        ...
        con = CAsyncSequenceConnection(self, child, self._d_timeout);
    ...
    def send(self, con_id, data):
        ...
        self._d_logger.debug("Cons for %s: %s"%(addr, cons))
