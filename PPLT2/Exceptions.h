 ...
 * PLEASE use allways one of the classes listed for throwing an
 * exception. If you want to define you own exceptions, please derive
 * it at least from the class @see Error. Because the methods of all
...
namespace PPLTCore{
    ...
    public:
        ...
        * need this message.
        * @param msg The message for the exceptions. May be the reason
        * for the exception.
        */
        Error(std::string);
    ...
    class CoreError: public Error{
        public:
            /** Constructor
            * This constructor takes a string @param message, that
