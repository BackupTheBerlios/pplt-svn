...
A core module is allways a small python script with a specific interface 
ziped into an archive. This archive have to consists of at least two
...
This file should include or contain the python sourcecode of the core
module.

In the following sections I will descibe all core modules avaiable until
now. Or all that I know of.



\section{Master modules}
Master mdodules are modules that are used in the PPLT devices. So this
...
connect to the tunneld ToolPort of a Panasoinc 
PLC. 
