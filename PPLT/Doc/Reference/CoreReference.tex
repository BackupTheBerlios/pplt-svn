...
on Error. So an \exception{ItemNotFound}-exception will be raised if 
\ver{ParentID}
\end{methoddesc}
...
This method will return \code{Ture} if the folder was successfully created and 
