...
DEFINE( "CT_RETURN_ADDRESS", "hmatuschek@gmx.net" );
...
DEFINE( "CT_GUESTS_CAN_CREATE", TRUE );
...
DEFINE( "CT_PRIVATE_KEY", "xxSwe67r7BBrdfxc2s2VBF436U6l98878Syye23k18u3k212aAQW35GBSAQ2jkgyce63jd8hyhhnrt" );
...
DEFINE( "CT_BUG_SEVERITIES",  "Fatal,Serious,Minor,Cosmetic,Change Req.,Feature Req.");
...
DEFINE( "CT_MAJOR_BROWSERS", ",IE 6.0,IE 5.5,IE 5.0,IE 4.0,NN 6,NN 4.7,AOL 9,AOL 8," .
			"AOL 7,AOL 6,Opera 7,Opera 6,Opera 5,Mozilla,Safari,IE Mac,(see note),N/A" );
...
DEFINE( "CT_CODE_VERSION", "v. 0.99.1" );
